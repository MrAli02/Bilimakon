...
export default function SimulatorGate({ activeAttempt, price }: Props) {
    ...
    return (
      <div className="card p-6">
        ...
        <p className="text-sm mb-5" style={{ color: "var(--text-secondary)" }}>
          To'lovingiz tasdiqlangan. Simulyatorni boshlashingiz mumkin.
        </p>
        <Link href="/tests/simulator/start"
          ...
          <Play size={18} fill="white" /> Simulyatorni boshlash
        </Link>
      </div>
    );
  }
